...
wrapper.languages.update = async (token, id, lang, data, fuzzy_trigger) => {
  return await languages.update(token, id, lang, data, fuzzy_trigger);
};

// Terms
wrapper.terms.list = async (token, id, language) => {
  return await terms.list(token, id, language);
};
